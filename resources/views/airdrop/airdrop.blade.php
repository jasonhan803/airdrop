...
$('#register_user').submit(function(e){
    ...
    if(response.status == 'succ'){
      ...
      $('#register_user').html('<i class="fa fa-check-circle" aria-hidden="true"></i><br><br><button onclick="chaleja()" class="btn btn-xl btn-primary" id="crowdsale" type="button" style="margin-left: 19%;">Particapte to Crowdsale</button>')
    }
  });
